...
Token 估算使用 [gpt-tokenizer](https://github.com/niieani/gpt-tokenizer)（cl100k_base encoding），與 OpenAI / Anthropic 的實際 tokenizer 高度一致。如果 API response 有官方 `usage` 欄位就直接用官方數字。
...
**🌍 多語系支援**
- 支援 55 種語言，涵蓋 Chrome 支援的所有 locale
- 包含 English, 繁體中文, 简体中文, 日本語, 한국어, Español, Français, Deutsch, Português, Italiano, Русский, العربية, हिन्दी, ไทย, Tiếng Việt, Bahasa Indonesia, Türkçe, Polski, Nederlands, Svenska, Dansk, Norsk, Suomi 以及更多
- Extension 會自動偵測你的 Chrome 語言設定，無需手動切換
...
直接從 [Chrome Web Store 安裝](https://chrome.google.com/webstore/detail/TODO_FILL_AFTER_APPROVAL)。
